    ...
    <div className="px-4 py-6 space-y-8">
      <div className="flex items-center justify-between flex-wrap">
        ...
        <div className="space-x-2">
          {priority && (
            <span className="bg-red-500 rounded-full py-1 px-3 text-sm uppercase font-semibold gap-2 text-red-50 tracking-wide">
              Priority
            </span>
          )}
      ...
      <div className="flex items-center gap-2 bg-stone-200 py-5 px-6 justify-between flex-wrap">
